...
{
	uint8_t p;
	p = 0x50;											//unlock SPI flash
	HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, 0);
	HAL_SPI_Transmit(&_W25QXX_SPI, &p, 1, HAL_MAX_DELAY);
	HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, 1);
	HAL_Delay(1);
...
{
	uint8_t	ret;
	HAL_SPI_TransmitReceive(&_W25QXX_SPI,&Data,&ret,1,5);
	return ret;
}
//###################################################################################################################
uint32_t W25qxx_ReadID(void)
{
  ...
  W25qxx_Spi(0x00);
  W25qxx_Spi(0x00);
  Temp0 = W25qxx_Spi(0x00);
  Temp1 = W25qxx_Spi(0x00);
...
bool	W25qxx_Init(void)
{
	...
	w25qxx.BlockCount = 128;			//1Mbit Hafıza
	w25qxx.PageSize=256;
	w25qxx.SectorSize=0x1000;
	w25qxx.SectorCount=w25qxx.BlockCount*8;
	w25qxx.PageCount=(w25qxx.SectorCount*w25qxx.SectorSize)/w25qxx.PageSize;
	w25qxx.BlockSize=w25qxx.SectorSize*8;
